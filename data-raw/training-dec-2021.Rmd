...
- Demo of PCT web app: 10 minutes

- Working together: Section 1 - downloading PCT data from the website and downloading PCT data in R (Section 1.2): 25 minutes
...
# Create the new scenario (first we replace some car journeys with journeys by foot, then we replace some of the remaining car journeys with journeys by bicycle)

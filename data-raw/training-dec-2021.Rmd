...
```{r switch map, echo=FALSE, fig.cap="After launching sandbox mode for the default map."}
...
```{r import dialog, echo=FALSE, fig.cap="Settings for importing a new city into A/B Street."}

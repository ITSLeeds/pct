...
For this section you will need to have installed the `abstr` package.
...
routes_towns_active %>% 
  sample_n(1000) %>% 
  mapview::mapview() # they are full routes
```
...
Therefore, before generating A/B Street scenarios, we will constrain the case study area to York.

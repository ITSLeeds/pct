...
```{abst title, echo=FALSE, fig.cap="The home screen for A/B Street."}
...
```{abst switch map, echo=FALSE, fig.cap="After launching sandbox mode for the default map."}
...
```{abst import dialog, echo=FALSE, fig.cap="Settings for importing a new city into A/B Street."}
...
```{abst geojson, echo=FALSE, fig.cap="geojson.io selecion of York."}
...
```{abst loading, echo=FALSE, fig.cap="While A/B Street imports York, you'll see a loading screen like this."}
...
```{abst york, echo=FALSE, fig.cap="An empty York in A/B Street."}
...
```{abst search, echo=FALSE, fig.cap="Searching by street"}
...
```{abst spawn, echo=FALSE, fig.cap="Example traffic around one intersection"}
...
```{abst follow, echo=FALSE, fig.cap="Following one traveller"}
...
```{abst edit, echo=FALSE, fig.cap="Editing a street"}
...
```{abst new lane, echo=FALSE, fig.cap="After adding a protected cycle lane"}
...
```{abst , echo=FALSE, fig.cap="Travel demand models available"}
...
```{abst , echo=FALSE, fig.cap="When do trips start?"}
...
```{abst , echo=FALSE, fig.cap="Start time distribution"}
...
```{abst , echo=FALSE, fig.cap="Population layer"}
...
```{abst , echo=FALSE, fig.cap="Delay layer"}
...
```{abst , echo=FALSE, fig.cap="Too many vehicles on a small street"}

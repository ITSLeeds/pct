...
```{r echo = TRUE, message=FALSE, warning=FALSE, fig.align="center", fig.width = 7, fig.height = 6}
  tm_shape(zones) +
    tm_fill(
...
We’re interested to know how you’be used the methods/data so please get in touch on <a href="https://twitter.com/robinlovelace">(social media)</a> and <a href="https://github.com/ITSLeeds/pct">(Github) </a> letting us know how get on. Any comments/contributions to this analysis: welcome.

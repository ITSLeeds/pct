...
The first step is to subset zones and OD pairs originating in York.^[
...
```{r york, fig.cap="Zones in York with colours representing cycling mode share (left) and urban functional classification (right)", echo=FALSE}
tm_shape(zones_york) +

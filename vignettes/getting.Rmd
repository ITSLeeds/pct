...
You can see how it works by opening the project pctqgis3.qgz in the [pctqgis.zip](https://github.com/ITSLeeds/pct/releases/download/0.8.0/) file.
...
[^2]:  A great thing about QGIS projects is that, like RStudio projects, they make organising and sharing your work easier.
    You should be able to see exactly the same project state as that shown in the figure by downloading the zip file at <https://github.com/ITSLeeds/pct/releases/download/0.8.0/> and opening the pctqgis1.qgz file in QGIS.

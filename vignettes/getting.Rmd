...
-   Develop your own uptake model in conceptual terms, e.g., to represent the [government's aim](https://assets.publishing.service.gov.uk/government/uploads/system/uploads/attachment_data/file/1009448/decarbonising-transport-a-better-greener-britain.pdf) for 50% of all trips in towns and cities to be made by walking and cycling by 2030
-   Learn how to train uptake models against data, to build evidence-based uptake models

## Set-up

To undertaken the exercises in this section you need to have R and RStudio installed, as outlined [here](https://itsleeds.github.io/pct/articles/pct_training.html#preparation).
...
```{r dutch_pcycle, echo=FALSE, warning=FALSE, fig.show='hold', fig.cap="Percent cycling currently (left) and under a 'Go Dutch' scenario (right) in the North Yorkshire."}

...
```{r lines-1, echo=FALSE}
knitr::include_graphics("vignette-pct-lines-1.png")
```
...
```{r routes-fast, echo=FALSE}
knitr::include_graphics("vignette-pct-routes-fast-1.png")
```
...
```{r goducth-1, echo=FALSE}
knitr::include_graphics("vignette-pct-goducth-1.png")
```

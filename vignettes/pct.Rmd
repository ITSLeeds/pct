...
```{r centroids-1, echo=FALSE}
knitr::include_graphics("vignette-centroids-1.png")
```
...
```{r get_pct_lines-1, echo=FALSE}
knitr::include_graphics("vignette-get_pct_lines-1.png")
```

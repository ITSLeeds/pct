...
Furthermore, using open source software with a command-line interface reduces barriers to entry in the planning process enabling it to become more citizen-led and participatory [@lovelace_open_2020].

...
- G5: Using the function `get_pct_lines()`, identify the top 5 MSOA to MSOA **desire lines** that have the highest number of people who cycle to work.
...
```{r, echo=FALSE, warning=FALSE, fig.show='hold', fig.cap="Top 5 desire lines with highest number of people cycling (left) and driving (right) in the Isle of Wight."}
...
```{r, eval=FALSE}
# at the lsoa level
l_original = get_pct_lines("isle-of-wight", geography = "lsoa")
l = l_original %>% 
  select(geo_code1, geo_code2, all, bicycle, car_driver)
View(l)
l %>% 

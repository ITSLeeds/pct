...
This article demonstrates how to retrieve cycling potential data for any UK city, down to the route network level (see [`vignette("cycling-potential-uk")`](https://itsleeds.github.io/pct/articles/cycling-potential-uk.html) for a tutorial showing how the package can provide cycling uptake estimates at the area level), and how to use the results to see which streets will have high potential (and where to prioritise investment). 
